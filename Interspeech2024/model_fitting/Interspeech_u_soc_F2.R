# script for univariate F2 "social predictors" model
...
# There are many other possible choices for the interactions to fit. Here, we
# just decided to let the effect of each of duration, birthyear, and gender vary
# for each context x vowel, but we could have fit even more interactions if we
# wanted to.
F2 = bf(zF2 ~ 
...
model <- brm(F2,
             data=dataset, 
             file=paste("../models/", corpus, "_u_soc_F2", sep=""), 
