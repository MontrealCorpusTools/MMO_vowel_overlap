...
The good thing about this way of viewing uncertainty is that it demonstrates that the variability is actually *less* than what just the errorbars show, i.e., the draws vary mostly in their intercepts, not their slopes.
...
p_BA_oral <- BA_mod_sp_wide %>%
  ggplot(aes(x=reorder(speaker, nasal), y=oral, color=speaker)) +
  geom_point() +
...
p_BA_diff <- BA_mod_sp_wide %>%
  ggplot(aes(x=reorder(speaker, nasal), y=diff, color=speaker)) +
  geom_point() +
