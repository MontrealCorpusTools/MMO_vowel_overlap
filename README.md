This is the code accompanying [our Interspeech 2024 paper](https://www.isca-archive.org/interspeech_2024/smith24_interspeech.html). The main folder contains a tutorial on MMO that is designed to be run on a personal laptop, and the Interspeech2024 folder contains the code used for the analysis in the Interspeech paper. 
